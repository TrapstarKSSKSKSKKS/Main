...
local tab1, tab2, tab3, tab4, tab5 = gui:AddTab("Main"), gui:AddTab("Farm Options"), gui:AddTab("Trainer"), gui:AddTab("Misc"), gui:AddTab("Credits")
...
local myData = loadstring(game:HttpGet("https://raw.githubusercontent.com/z4gs/scripts/master/Settings.lua"))().new("Ro-Ghoul-Trapstar", {
    Skills = {
        E = false,
        F = false,
        C = false,
...
tab4:AddLabel("Change to Ghoul")
tab4:AddButton("Ghoul", function()
    local targetPlayer = player
    local targetTeam = "Ghoul"
    game:GetService("Players")player.PlayerFolder.Customization.Team = "Ghoul"
end)
...
tab5:AddLabel("Maxx - for a better auto key grabber")
tab5:AddButton("Copy V3rmillion profile", function()
    setclipboard("https://v3rmillion.net/member.php?action=profile&uid=586718")
...
tab5:AddLabel("Singularity - for the UI Library")
tab5:AddButton("Copy V3rmillion profile", function()
    setclipboard("https://v3rmillion.net/member.php?action=profile&uid=947830")
    game:GetService('StarterGui'):SetCore('SendNotification', {
        Title = "Copied",
        Text = "Link set to clipboard",
        Duration = 3
...
tab5:AddLabel("")
tab5:AddLabel("z4gS- I totally used his script as the basis for this one\n just removed things that in my opinion were useless\n (Script credit goes fully to him)")
tab5:AddLabel("")
tab5:AddButton("Copy V3rmillion profile", function()
    setclipboard("https://v3rmillion.net/member.php?action=profile&uid=1169708")
    game:GetService('StarterGui'):SetCore('SendNotification', {
        Title = "Copied",
        Text = "Link set to clipboard",
        Duration = 3
